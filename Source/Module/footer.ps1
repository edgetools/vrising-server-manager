...
$Global:PSDefaultParameterValues['Enable-VRisingServerMonitor:ErrorAction'] = 'Continue'
$Global:PSDefaultParameterValues['Disable-VRisingServerMonitor:ErrorAction'] = 'Continue'
